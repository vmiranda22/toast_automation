...
df = spark.read.format("json") \
       ...
       .load("abfss://b08d383a-b8cc-4b8e-b189-d9d696a01977@onelake.dfs.fabric.microsoft.com/fd91a974-12de-4aed-9135-cd6bfb991855/Files/JSON_tasks")
...
query = f"""
DELETE FROM LH_Workfront.flattened_tasks
WHERE ID IN ({ids_str})
"""
...
flattened_df.withColumnRenamed("DE:Time Type", "timeType").write.format("delta").mode("append").save("Tables/flattened_tasks")
