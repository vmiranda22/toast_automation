...
dataset = "direct_lake_semantic_model" # Enter the name or ID of the semantic model
workspace = "USGH Operations Automation & Tooling Team - DEV" # Enter the workspace name or ID in which the semantic model exists
