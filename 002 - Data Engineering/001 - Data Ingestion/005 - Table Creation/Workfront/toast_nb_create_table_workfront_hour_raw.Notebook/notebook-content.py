...
timestamp_columns_raw = {
    "approvedOnDate", "entryDate", "lastUpdateDate", "rejectedOnDate"
}
...
base_columns_raw = [
    "ID", "objCode", "actualCost", "approvedByID", "approvedOnDate",
    "assignedApproverID", "billingRecordID", "categoryID", "customerID",
    "days", "description", "dupID", "entryDate", "extRefID", "hasRateOverride",
    "hourTypeID", "hours", "isBillable", "lastUpdateDate", "lastUpdatedByID",
    "opTaskID", "ownerID", "projectID", "projectOverheadID", "rejectedByID",
    "rejectedOnDate", "rejectionComment", "resourceRevenue", "roleID",
    "securityRootID", "securityRootObjCode", "status", "submittedByID",
    "taskID", "timesheetHourIdentifier", "timesheetID", "workHoursPerDay"
]
...
empty_df.write.format("delta").mode("ignore").saveAsTable("workfront_hour_raw")
