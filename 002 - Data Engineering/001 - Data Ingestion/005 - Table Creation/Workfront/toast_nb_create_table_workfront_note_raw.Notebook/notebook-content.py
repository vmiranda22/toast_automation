...
base_columns_raw = [
    "ID", "objCode", "attachDocumentID", "attachObjCode", "attachObjID", "attachOpTaskID",
    "attachWorkID", "attachWorkObjCode", "attachWorkUserID", "auditRecordID", "auditText",
    "auditType", "customerID", "documentID", "entryDate", "extRefID", "hasReplies", "html",
    "indent", "isDeleted", "isMessage", "isPrivate", "isReply", "iterationID", "noteObjCode",
    "noteText", "numLikes", "numReplies", "objID", "opTaskID", "ownerID", "parentEndorsementID",
    "parentJournalEntryID", "parentNoteID", "portfolioID", "programID", "projectID",
    "proofActionID", "proofID", "richTextNoteID", "securityRootID", "securityRootObjCode",
    "subject", "taskID", "templateID", "templateTaskID", "threadDate", "threadID", "timesheetID",
    "topNoteObjCode", "topObjID", "userID"
]
...
empty_df.write.format("delta").mode("ignore").saveAsTable("workfront_note_raw")
